...
#ifndef DASTS2_VERSION9_C_RANDOM_H
#define DASTS2_VERSION9_C_RANDOM_H
...
namespace effolkronium
{
    ...
    namespace details
    {
        ...
        struct is_uniform_int
        {
            static constexpr bool value =
                std::is_same<T, short>::value || std::is_same<T, int>::value || std::is_same<T, long>::value || std::is_same<T, long long>::value || std::is_same<T, unsigned short>::value || std::is_same<T, unsigned int>::value || std::is_same<T, unsigned long>::value || std::is_same<T, unsigned long long>::value;
        };
        ...
        {
            static constexpr bool value =
                is_byte<T>::value || is_uniform_real<T>::value || is_uniform_int<T>::value;
        };
        ...
        {
            static constexpr bool value =
                std::is_same<T, char>::value || std::is_same<T, wchar_t>::value || std::is_same<T, char16_t>::value || std::is_same<T, char32_t>::value;
        };
    ...
    public:
        ...
        static typename std::enable_if<
            std::is_same<Key, common>::value && details::is_supported_number<A>::value && details::is_supported_number<B>::value
         ...
         */
        template <typename T>
        static typename std::enable_if<details::is_supported_character<T>::value, T>::type get(T from = (std::numeric_limits<T>::min)(),
                                                                                               T to = (std::numeric_limits<T>::max)())
        {
            if (from < to) // Allow range from higher to lower
        ...
        static typename std::enable_if<details::is_iterator<InputIt>::value, InputIt>::type get(InputIt first, InputIt last)
        {
        ...
        static typename std::enable_if<
            details::has_reserve<Container<A>>::value, Container<A>>::type
        get(A from, A to, std::size_t size)
        {
        ...
        template <
            ...
            typename C = typename std::common_type<A, B>::type>
        static typename std::enable_if<
            std::is_same<Key, common>::value && details::has_reserve<Container<A>>::value, Container<C>>::type
        get(A start, B end, std::size_t size)
        {
        ...
        static typename std::enable_if<
            !details::has_reserve<Container<A>>::value, Container<A>>::type
        get(A start, A end, std::size_t size)
        {
            Container<A> container;
        ...
        template <
            ...
            typename C = typename std::common_type<A, B>::type>
        static typename std::enable_if<
            std::is_same<Key, common>::value && !details::has_reserve<Container<C>>::value, Container<C>>::type
        get(A start, B end, std::size_t size)
        {
            Container<C> container;
        ...
        static typename std::enable_if<
            !details::has_insert<Container<A, N>>::value, Container<A, N>>::type
        get(A start, A end)
        {
        ...
        template <
            ...
            typename C = typename std::common_type<A, B>::type>
        static typename std::enable_if<
            std::is_same<Key, common>::value && !details::has_insert<Container<C, N>>::value, Container<C, N>>::type
        get(A start, B end)
        {
    ...
    public:
         ...
         */
        template <typename T>
        typename std::enable_if<details::is_supported_character<T>::value, T>::type get(T from = (std::numeric_limits<T>::min)(),
                                                                                        T to = (std::numeric_limits<T>::max)())
        {
            if (from < to) // Allow range from higher to lower
